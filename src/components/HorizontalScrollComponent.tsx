...
//   { number: "01", heading: "Introduction", detail: "Detail about Introduction" },
//   { number: "02", heading: "Features", detail: "Detail about Features" },
//   { number: "03", heading: "Gallery", detail: "Detail about Gallery" },
//   { number: "04", heading: "Contact", detail: "Detail about Contact" },
// ];
...
//     // Create snapping horizontal scroll
//     gsap.to(sections, {
...
//     // Sidebar animation for each section
//     sections.forEach((section: any, i: number) => {
//       ScrollTrigger.create({
//         trigger: section,
//         start: "center center",
//         end: "center center",
//         onEnter: () => gsap.to(`#sidebar-${i + 1}`, { x: 0, opacity: 1, duration: 0.5 }),
//         onLeave: () => gsap.to(`#sidebar-${i + 1}`, { x: "-100%", opacity: 0, duration: 0.5 }),
//         onEnterBack: () => gsap.to(`#sidebar-${i + 1}`, { x: 0, opacity: 1, duration: 0.5 }),
//         onLeaveBack: () => gsap.to(`#sidebar-${i + 1}`, { x: "-100%", opacity: 0, duration: 0.5 }),
//       });
//     });
//   }, []);
...
//       <div className="flex h-screen w-[400vw] overflow-hidden">
//         {sections.map((section, i) => (
//           <div
//             key={i}
//             className="section flex w-screen items-center justify-center relative bg-gray-900 text-white"
//           >
//             {/* Left Sidebar */}
//             <motion.div
//               id={`sidebar-${i + 1}`}
//               className="absolute left-0 w-1/3 h-full flex items-center p-8 bg-gray-800 shadow-lg transform -translate-x-full opacity-0 transition-all duration-500"
//             >
//               <div className="text-lg">{section.detail} hahahaha</div>
//             </motion.div>

//             {/* Right Content */}
//             <div className="w-2/3 flex flex-col items-center">
//               <div className="text-9xl text-gray-700 font-bold opacity-30 absolute top-1/4 left-1/3 transform -translate-x-1/2">
//                 {section.number}
//               </div>
//               <h2 className="text-5xl font-bold mb-8">{section.heading}</h2>
